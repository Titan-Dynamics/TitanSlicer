...
void GUI_App::init_label_colours()
{
    ...
    m_color_highlight_default       = is_dark_mode ? wxColour("#26262B") : wxColour("#F1F1F1"); // TitanSlicer
    ...
    m_color_selected_btn_bg         = is_dark_mode ? wxColour(64, 64, 71)   : wxColour(206, 206, 206); // TitanSlicer
#else
    m_color_label_default = wxSystemSettings::GetColour(wxSYS_COLOUR_WINDOWTEXT);
#endif
    m_color_window_default          = is_dark_mode ? wxColour(29, 29, 33)   : wxSystemSettings::GetColour(wxSYS_COLOUR_WINDOW); // TitanSlicer
