...
#define SLIC3R_APP_FULL_NAME "Titan Slicer"
#define GCODEVIEWER_APP_NAME "TitanSlicer G-code Viewer"
#define GCODEVIEWER_APP_KEY  "TitanSlicerGcodeViewer"
#define GCODEVIEWER_BUILD_ID std::string("TitanSlicer G-code Viewer-") + std::string(SLIC3R_VERSION) + std::string("-RC")
